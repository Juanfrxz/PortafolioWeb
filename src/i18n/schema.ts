...
export const dictionarySchema = z.strictObject({
  ...
  capabilities: z.strictObject({
    ...
    graphToolbar: nonemptyString,
    selected: nonemptyString,
    select: nonemptyString,
    technologies: nonemptyString,
    projects: nonemptyString,
  ...
  contact: z.strictObject({
    ...
    nameInvalid: nonemptyString,
    emailInvalid: nonemptyString,
    messageInvalid: nonemptyString,
